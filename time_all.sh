...
then
    ...
    do
        ...
        compare_result=$(echo "$elapsed > 1.0" | bc)
        if [ $compare_result -ne 0 ]
        then
            echo -e "$problem ${BRed}$elapsed${Color_Off}"
        else
            echo -e "$problem ${BGreen}$elapsed${Color_Off}"
        fi
    done
else
    ...
    if [ $compare_result -ne 0 ]
    then
        echo -e "$@ ${BRed}$elapsed${Color_Off}"
    else
        echo -e "$@ ${BGreen}$elapsed${Color_Off}"
    fi
fi
